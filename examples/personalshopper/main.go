...
import (
	...
	swarm "github.com/rsaranusc/agentkit"
...
ask them for user_id and method in one message.`,
		Functions: []swarm.AgentFunction{
			{
				...
				Parameters: map[string]any{
					...
					"required": []any{"user_id", "product_id"},
				},
				Function: orderItem,
			},
			{
	...
	transferToSalesAgent := swarm.AgentFunction{
		...
		Function: func(args map[string]any, contextVariables map[string]any) swarm.Result {
			return swarm.Result{
				Agent: salesAgent,

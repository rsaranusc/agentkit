...
func main() {
	...
	supervisorAgent := &agentkit.Agent{
...
"route to SupervisorAgent"`,
	...
	workflow.AddAgentToTeam(dataAgent, agentkit.DocumentTeam)
	workflow.AddAgentToTeam(analystAgent, agentkit.AnalysisTeam)

...
func printStepResult(step agentkit.StepResult) {
...
func main() {
	...
	initialContent := `Introduction: agentkit is a Go package that allows you to create AI agents capable of interacting, coordinating, and executing tasks. Inspired by OpenAI's Swarm framework, agentkit focuses on making agent coordination and execution lightweight, highly controllable, and easily testable.
...
`
	...
	workflow.SetCycleHandling(agentkit.ContinueOnCycle)
...
Make direct changes to the content, don't delegate tasks.`,
	...
	if err := workflow.SetTeamLeader(editor.Name, agentkit.DocumentTeam); err != nil {

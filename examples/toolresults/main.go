...
func calculateSum(args map[string]interface{}, contextVariables map[string]interface{}) agentkit.Result {
...
func calculateProduct(args map[string]interface{}, contextVariables map[string]interface{}) agentkit.Result {
	num1 := int(args["num1"].(float64))
	num2 := int(args["num2"].(float64))
	product := num1 * num2
	return agentkit.Result{

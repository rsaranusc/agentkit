...
func main() {
	...
	creator := agentkit.NewDynamicWorkflowCreator(apiKey, llm.OpenAI)
...
func createResearcherAgent() *agentkit.Agent {
	return &agentkit.Agent{
		Name: "Researcher",
		...
		Functions: []agentkit.AgentFunction{
			{
				...
				Function: func(args map[string]any, ctx map[string]any) agentkit.Result {
...
func createWriterAgent() *agentkit.Agent {
	return &agentkit.Agent{
		Name: "Writer",
...
func createAnalystAgent() *agentkit.Agent {
	return &agentkit.Agent{
		Name: "Analyst",
...
func createCoderAgent() *agentkit.Agent {
	return &agentkit.Agent{
		Name: "Coder",
		...
		Functions: []agentkit.AgentFunction{
			{
				...
				Parameters: map[string]any{
					...
					"required": []any{"requirements", "language"},
				},
				Function: func(args map[string]any, ctx map[string]any) agentkit.Result {
...
func createSupervisorAgent() *agentkit.Agent {
	return &agentkit.Agent{
		Name: "Supervisor",
